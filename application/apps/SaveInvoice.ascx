                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <label>Client/Supplier Name</label>
                                            <asp:DropDownList ID="ddClientName" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddClientName_SelectedIndexChanged">
                                                <asp:ListItem>False</asp:ListItem>
                                                <asp:ListItem>True</asp:ListItem>
                                            </asp:DropDownList>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <asp:TextBox ID="txtxInvoiceDate" Style="z-index: 10000;" runat="server" CssClass="form-control" placeholder="Enter text" />
