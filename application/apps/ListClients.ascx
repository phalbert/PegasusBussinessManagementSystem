<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListClients.ascx.cs" Inherits="ListClients" %>
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Details">
                                    <ItemTemplate>
                                        ...
                                        <asp:Button ID="btnMakeASale" runat="server" Text="Make A Sale" CommandName="MakeASale" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
