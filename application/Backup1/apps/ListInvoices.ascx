<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListInvoices.ascx.cs" Inherits="ListInvoices" %>
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Details">
                                    <ItemTemplate>
                                        ...
                                        <asp:Button ID="btnCompleteSale" runat="server" Text="Generate Reciept" CommandName="CompleteSale" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
