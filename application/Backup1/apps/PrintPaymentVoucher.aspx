<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintPaymentVoucher.aspx.cs" Inherits="PrintPaymentVoucher" %>
                                    ...
                                    <div class="row">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="col-md-9"><em>Voucher Code</em></td>
                                                    <td class="col-md-3" style="text-align: center">
                                                        <asp:Label ID="lblVoucherCode" runat="server"></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-9"><em>Voucher Amount</em></td>
                                                    <td class="col-md-3" style="text-align: center">
                                                        <asp:Label ID="lblVoucherAmount" runat="server"></asp:Label></td>
                                                </tr>
                                                <tr>
