<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListPurchases.ascx.cs" Inherits="ListPurchases" %>
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Details">
                                    <ItemTemplate>
                                        ...
                                        <asp:Button ID="btnGeneratePaymentVoucher" runat="server" Text="Generate Payment Voucher" CommandName="GenerateVoucher" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
