                                    ...
                                    <div class="row">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="col-md-9"><em>Client Code </em></td>
                                                    <td class="col-md-1" style="text-align: center">
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    <td class="col-md-9"><em>Invoice Date </em></td>
                                                    <td class="col-md-1" style="text-align: center">
                                                        <asp:Label ID="lblInvoiceDate" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-9"><em>Invoice Amount</em></td>
                                                    <td class="col-md-3" style="text-align: center">
                                                        <asp:Label ID="lblInvoiceAmount" runat="server"></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-9"><em>Tax Amount</em></td>
                                                    <td class="col-md-3" style="text-align: center">
                                                        <asp:Label ID="lblTaxAmount" runat="server"></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-9"><em>Any Other Tax Amount</em></td>
                                                    <td class="col-md-3" style="text-align: center">
                                                        <asp:Label ID="lblAnyOtherTax" runat="server"></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-9"><em>Discount Account</em></td>
                                                    <td class="col-md-3" style="text-align: center">
                                                ...
                                                <tr>
                                                    <td class="col-md-9"><em>Total Invoice Amount</em></td>
                                                    <td class="col-md-1" style="text-align: center">
                                                        <asp:Label ID="lblTotalInvoiceAmount" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-9"><em>Currency Code</em></td>
                                                    <td class="col-md-1" style="text-align: center">
                                                        <asp:Label ID="lblCurrencyCode" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-9"><em>Reason </em></td>
                                                    <td class="col-md-1" style="text-align: center">
