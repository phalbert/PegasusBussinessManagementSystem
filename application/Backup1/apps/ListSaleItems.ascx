<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListSaleItems.ascx.cs" Inherits="ListSaleItems" %>
                        ...
                        <asp:GridView runat="server" Width="100%" CssClass="table table-bordered table-hover"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Details">
                                    <ItemTemplate>
                                        <asp:Button ID="btnMakeASale" runat="server" Text="Go To Sale" CommandName="GoToSale" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
