<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListPaymentVouchers.ascx.cs" Inherits="ListPaymentVouchers" %>
    ...
    <asp:View ID="SearchView" runat="server">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <asp:DropDownList ID="ddIsUsed" runat="server" CssClass="form-control">
                        ...
                        <asp:GridView runat="server" Width="100%" CssClass="table table-bordered table-hover"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Details">
                                    <ItemTemplate>
                                        <asp:Button ID="btnCompleteVoucherPayment" runat="server" Text="Complete Voucher Payment" CommandName="CompletePaymentVoucher" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
