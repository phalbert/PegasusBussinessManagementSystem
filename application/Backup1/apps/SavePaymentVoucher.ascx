<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SavePaymentVoucher.ascx.cs" Inherits="SavePaymentVoucher" %>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-heading text-center">
                                    SUPPLY THE PAYMENT VOUCHER DETAILS USING THE FORM BELOW
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <asp:TextBox ID="txtVoucherCode" runat="server" CssClass="form-control" placeholder="Enter text" />
                                            <p class="help-block">The Unique Text Identifier for Voucher Code</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <label>Invoice</label>
                                            <asp:DropDownList ID="ddInvoices" runat="server" CssClass="form-control">
                                                <asp:ListItem>False</asp:ListItem>
                                                <asp:ListItem>True</asp:ListItem>
                                            </asp:DropDownList>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <asp:TextBox ID="txtVoucherAmount" runat="server" CssClass="form-control" placeholder="Enter text" onkeyup="javascript:this.value=Comma(this.value);"  />
                                            <p class="help-block">How Much This Payment Voucher is worth</p>
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            <p class="help-block">Currency of this Payment Voucher</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <p class="help-block">The Reason for this Voucher</p>
                                        </div>
                                        <div class="col-lg-6">
                                            <label>Is Used</label>
                                            ...
                                            <p class="help-block">Is this Voucher Used</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
