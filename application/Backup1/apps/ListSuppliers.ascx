<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListSuppliers.ascx.cs" Inherits="ListSuppliers" %>
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Details">
                                    <ItemTemplate>
                                        ...
                                        <asp:Button ID="btnPurchase" runat="server" Text="Register Purchase" CommandName="RegisterPurchase" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
